                 ...
                 <div class="col-lg-2 col-md-12">
                     <div class="footer-widget widget_logo wow fadeInUp delay-0-2s">
                         <div class="footer-logo">
                             <a href="index.html"><img src="{{ frontImage('logos/logo.png') }}"
                                     alt="Logo"></a>
                         </div>
                     </div>
                 </div>
 ...
 <!-- Jquery -->
 <script src="{{ frontJs('jquery-3.6.0.min.js') }}"></script>
 <!-- Bootstrap -->
 <script src="{{ frontJs('bootstrap.min.js') }}"></script>
 <!-- Appear Js -->
 <script src="{{ frontJs('appear.min.js') }}"></script>
 <!-- Slick -->
 <script src="{{ frontJs('slick.min.js') }}"></script>
 <!-- Nice Select -->
 <script src="{{ frontJs('jquery.nice-select.min.js') }}"></script>
 <!-- Image Loader -->
 <script src="{{ frontJs('imagesloaded.pkgd.min.js') }}"></script>
 <!-- Isotope -->
 <script src="{{ frontJs('isotope.pkgd.min.js') }}"></script>
 <!-- WOW Animation -->
 <script src="{{ frontJs('wow.min.js') }}"></script>
 <!-- Custom script -->
 <script src="{{ frontJs('script.js') }}"></script>

 <!-- For Contact Form -->
 <script src="{{ frontJs('jquery.ajaxchimp.min.js') }}"></script>
 <script src="{{ frontJs('form-validator.min.js') }}"></script>
 <script src="{{ frontJs('contact-form-script.js') }}"></script>
