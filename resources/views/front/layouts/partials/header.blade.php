                ...
                <div class="container container-1620 clearfix">
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="index.html"><img src="{{ asset('assets/front/images/logos/logo.png') }}" alt="Logo"></a></div>
                        </div>
                        ...
                        <div class="menu-btns">
                            ...
                            <div class="menu-sidebar">
                                <button>
                                <img src="{{ asset('assets/front/images/shape/sidebar-tottler.svg') }}" alt="Toggler">
                                </button>
                            </div>
                        </div>
                    </div>
